...
6. **Update Documentation & Changelog**
   - บันทึกการแก้ไขลงใน `client-ts/CHANGELOG.md` (ภายใต้หัวข้อ Unreleased หรือ Version ถัดไป)
   - หากมีการ Bump Version ให้รัน `npm test` และ `npm run build` เพื่อตรวจสอบความถูกต้อง
   - รัน `npm run dev` เพื่อตรวจสอบว่าหน้าเว็บทำงานได้ปกติ
   - หากมีการเปลี่ยนแปลง Logic หรือ Configuration สำคัญ ให้อัปเดตเอกสารที่เกี่ยวข้อง
